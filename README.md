...
|Substance Package        |SBAR_       |            |                                  |
|Substance Material Instance|SBS_      |_INST       |                                  |
|Blueprint(Gamemode)      |GM_         |            |                                  |
|Blueprint(Gamemode actor)|GMA_        |            |                                  |
...
## Source
This style guide was adapted from the one by [Gamemakin LLC](https://github.com/CleanCut/UE4StyleGuide/blob/master/README.md)
